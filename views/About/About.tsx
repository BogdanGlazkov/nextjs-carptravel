      ...
      <div className="container md:relative">
        <div className="md:flex md:justify-between lg:justify-start lg:gap-[24px]">
          ...
          <div className="max-w-[180px] md:max-w-[225px] lg:w-[292px] mdOnly:ml-auto">
            ...
            <p className="font-extralight leading-[20px] lg:leading-[24px] md:text-[16px] lg:text-[18px]">
        ...
        <div className="xs:mt-[40px] lg:flex lg:flex-row-reverse lg:justify-between lg:mt-[72px]">
          <p className="block w-[180px] md:w-[221px] lg:w-[298px] xs:ml-auto text-[14px] md:text-[16px] lg:text-[18px] font-extralight mdOnly:absolute mdOnly:bottom-[188px] mdOnly:left-[32px] leading-[20px] lg:leading-[24px] tracking-[-0.14px]">
